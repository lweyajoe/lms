...
$logged_in_manager_email = $_SESSION['email'];
...
// Retrieve manager data using email
$manager_query = $conn->prepare("SELECT * FROM managers WHERE email = ?");
$manager_query->bind_param("s", $logged_in_manager_email);
...
if ($manager_data) {
    $performance_data = generateManagerBusinessPerformanceReport($conn, $manager_data['manager_id']);
    $profile_found = true;
}
?>
                                ...
                                <div class="profile-info-container" style="display: flex; justify-content: space-between; gap: 20px;">
                                    ...
                                    <div class="profile-info" style="width: 30%">
                                        ...
                                        <ul>
                                            ...
                                            <li><span>Total Interest Earned:</span> <?php echo htmlspecialchars($performance_data['total_interest_earned']); ?></li>
                                            <li><span>Total Payments Received:</span> <?php echo htmlspecialchars($performance_data['total_payments_received']); ?></li>
                                        </ul>
                                    </div>
                                    <!-- Contact Information -->
                                    <div class="profile-info" style="width: 30%">
