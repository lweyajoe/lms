            ...
            if ($loanData) {
                $insertQuery = "
                    INSERT INTO loan_info (
                        ...
                        collateral_value, collateral_pic1, collateral_pic2, guarantor1_name, guarantor1_phone, 
...
$loansQuery = "
    SELECT l.*, c.first_name, c.last_name, c.email, c.phone_number AS client_phone, c.county
