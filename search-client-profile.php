...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($national_id)) {
        ...
        if ($client_query) {
            ...
            $error_message = 'Error preparing client query: ' . htmlspecialchars($conn->error);
        }
        ...
        if ($loan_query) {
            ...
            if ($loan_query->execute()) {
                ...
                $error_message = 'Error executing loan query: ' . htmlspecialchars($conn->error);
            }
        } else {
            $error_message = 'Error preparing loan query: ' . htmlspecialchars($conn->error);
        }
                            ...
                            <div class="profile-info-container">
                                ...
                                <div class="profile-info">
                                    ...
                                    <ul>
                                        ...
                                        <li><span>Next of Kin Number:</span> <?php echo htmlspecialchars($client_data['next_of_kin_phone_number']); ?></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
