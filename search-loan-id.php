                ...
                <div class="search-icon-box card-box mb-30">
                    <form method="post" action="">
                        <input
                            ...
                            name="loan_id"
                            id="filter_input"
                            placeholder="Search Loan Profile: Enter Loan ID..."
                            title="Type in the loan's ID"
                            required
                        />
                            ...
                            <div class="pd-20 card-box height-100-p">
                                ...
                                <div class="profile-info-container" style="display: flex; justify-content: space-between; gap: 20px;">
                                    ...
                                    <div class="profile-info" style="width: 30%">
                                        ...
                                        <ul>
                                            <?php foreach ($loan_status_info as $label => $value): ?>
                                    ...
                                    <div class="profile-info" style="width: 30%">
                                        ...
                                        <ul>
                                            <?php foreach ($loan_details_info as $label => $value): ?>
                                                <li><span><?php echo htmlspecialchars($label); ?>:</span> <?php echo htmlspecialchars($value); ?></li>
                                            <?php endforeach; ?>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="profile-info" style="width: 30%">
                                        ...
                                        <ul>
                                            <?php foreach ($loan_security_info as $label => $value): ?>
                                                <li><span><?php echo htmlspecialchars($label); ?>:</span> <?php echo htmlspecialchars($value); ?></li>
                                            <?php endforeach; ?>
                                        </ul>
                                    </div>
